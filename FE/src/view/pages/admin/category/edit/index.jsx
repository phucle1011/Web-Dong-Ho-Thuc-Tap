...
function CategoryEdit() {
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                const res = await axios.get(`${Constants.DOMAIN_API}/admin/categories/${id}`);
                const { name, slug, description, status } = res.data;
                setValue("name", name);
                setValue("slug", slug);
    ...
    const onSubmit = async (formData) => {
        ...
        try {
            await axios.put(`${Constants.DOMAIN_API}/admin/categories/edit/${id}`, cleanedData);
