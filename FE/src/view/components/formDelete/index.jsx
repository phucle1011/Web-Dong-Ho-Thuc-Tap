...
export default function FormDelete({ isOpen, onClose, onConfirm, message, Id }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 mb-3">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center max-w-sm w-full">
                ...
                <div className="flex justify-center gap-4">
                    ...
                    <button onClick={onClose} className="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-md ms-2">
                        Hủy
                    </button>
                </div>
            </div>
